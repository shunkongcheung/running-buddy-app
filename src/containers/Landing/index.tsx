      ...
      <Row>
        <Col xs={12} md={6}>
          <Container className={classNames.contentContainer}>
            ...
            <p>
              ...
              sometimes running by yourself could be boring and given the
              current situation in the world, running with all your friends
              might be difficult and not recommended.
            </p>
            <Link href="/profile">
        ...
        <Col xs={12} md={6}>
          <Container className={classNames.contentContainer}>
            ...
            <p>
              What if you can invite friends in your bubble with a single click
              and ask them to join your run? "Running Buddy" is the perfect
              solution for you. With "Running Buddy" you can create your custom
              route, invite your buddies, and keep track of the journey. Since
              all the participants are tracked and saved securely in the system,
              if there's a need to revisit and check who joined you on a given
              day, it's easy as clicking a button.
            </p>
            <Link href="/login">
        ...
        <Container>
          <Row className={classNames.footerContent}>
            ...
            <Col xs={12} md={4} className={classNames.footerCol}>
              ...
              <Row>
                <Col xs={6} md={4}>
                  <AiFillFacebook className={classNames.smIcon} />
                </Col>
                <Col xs={6} md={4}>
                  <AiFillTwitterSquare className={classNames.smIcon} />
                </Col>
                <Col xs={6} md={4}>
                  <AiFillInstagram className={classNames.smIcon} />
                </Col>
              </Row>
            </Col>
          </Row>
